...
<div style="position:fixed;bottom:16px;right:16px;display:flex;gap:8px;z-index:100;">
  <a href="https://github.com/Give-N-Take" target="_blank" style="background:var(--surface);border:1px solid var(--border);border-radius:8px;padding:8px 14px;color:var(--text2);font-size:11px;text-decoration:none;display:flex;align-items:center;gap:5px;transition:all 0.2s;" onmouseover="this.style.borderColor='var(--accent)';this.style.color='var(--accent2)'" onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--text2)'">\u{1F4BB} View Source</a>
  <button class="roadmap-btn" style="position:static;" onclick="document.getElementById('roadmap-overlay').classList.add('visible')">\u{1F4CB} Roadmap</button>
</div>
